...
class AnswerResponse(BaseModel):
    ...
    sources: List[str] = Field(description="List of source document IDs used (list of strings)")
    confidence: float = Field(description="Confidence score between 0 and 1 (float)")
    timestamp: datetime = Field(description="When the response was generated (datetime)")
